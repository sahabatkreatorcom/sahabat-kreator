      ...
      {recentLocations.length > 0 && (
        <div>
          <button
            ...
            className="mb-1.5 flex items-center gap-1.5 font-medium text-[var(--text-muted)] text-xs hover:text-[var(--text-primary)]"
          >
        ...
        <div className="mb-2 flex flex-wrap gap-1">
          ...
          {categories.map((cat) => (
            <button
              ...
              className="rounded-full bg-[var(--bg-tertiary)] px-2.5 py-0.5 font-medium text-[var(--text-secondary)] text-xs transition-colors hover:bg-[var(--accent-gold-light)]"
            >
              {cat}
            </button>
          ))}
