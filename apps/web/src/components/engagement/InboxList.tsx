...
export function InboxList({ onSelect, selectedId }: InboxListProps) {
  ...
  const [_labelFilter, _setLabelFilter] = useState<string | null>(null);
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Header bar */}
      <div className="flex items-center justify-between border-[var(--border)] border-b p-3">
      ...
      {/* Filters */}
      <div className="flex flex-wrap items-center gap-2 border-[var(--border)] border-b p-2">
            ...
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <span
                      className={cn("truncate font-medium text-sm", !item.isRead && "font-bold")}
                    >
                      {item.authorName}
                    </span>
